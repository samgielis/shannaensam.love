...
const fullcreenProps = {h: '100vh', w: '100vw', minH: '-webkit-fill-available'}
export const App = () => {
  ...
  <Box>
    <Image pos='absolute' {...fullcreenProps} objectFit={'cover'} src={`bg-xs.jpg`}  zIndex='-1' filter='blur(2px)'/>
    <Image pos='absolute' {...fullcreenProps} objectFit={'cover'} srcSet={`bg-md.jpg 2048w, bg-lg.jpg 4096w, bg-full.jpg 4096w`}/>
      <Box
        textAlign="center"
        color="white"
        fontSize="xl"
